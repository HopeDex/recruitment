...
?>
 ...
 <h2>Current Job Updates</h2>
	...
	<Tr class="active">
		...
		<th style="text-align: left;">Pay grade</th>
		<th style="text-align: left;">Postions</th>
...
echo "<td>"."<a  href='juice.php'>"." "."</a>"."<a onClick='_confirm()' href='../hr/edit.php?Refference=".$row['Refference']."'>"."<button class='btn btn-primary' style='width:50px;margin-top:-6px;margin-bottom:8px;'>Edit</button>"." "."</a>"."<a onClick='_confirm()' href='../hr/delete.php?Refference=".$row['Refference']."'>"."<button class='btn' style='width:50; margin-top:-6px;  margin-bottom:8px; background-color:red; color:white;'>Delete</button>"." "."</a>"."</td>";
echo "</tr>";
$inc++;
};
